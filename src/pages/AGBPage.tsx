    ...
    <div className="flex flex-col min-h-screen bg-white text-black">
      ...
      <main className="flex-grow max-w-4xl mx-auto px-4 md:px-8 py-16 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mb-4">
          Allgemeine Geschäftsbedingungen von Artyom Afoshin Fotograf / Videograf (Einzelunternehmen)
        </h2>

        <section className="space-y-6 text-black">
          <div>
            <h3 className="font-semibold mt-6 mb-2 text-lg">1. Allgemeine Grundlagen</h3>
            <p><strong>1.1 Geltungsbereich und Begriffsbestimmungen</strong></p>
            ...
            <p className="mt-4"><strong>1.2 Vertragsschluss und Kommunikation</strong></p>
            ...
            <p className="mt-4"><strong>1.3 Entgelt und Zahlungsbedingungen</strong></p>
          ...
          <div>
            <h3 className="font-semibold mt-8 mb-2 text-lg">2. Leistungsgegenstand</h3>
            <p><strong>2.1 Foto- und Videodienstleistungen</strong></p>
            ...
            <p className="mt-4"><strong>2.2 Stornierungen und Terminänderungen</strong></p>
          ...
          <div>
            <h3 className="font-semibold mt-8 mb-2 text-lg">3. Gewährleistung und Haftung</h3>
          ...
          <div>
            <h3 className="font-semibold mt-8 mb-2 text-lg">4. Ergänzende Bestimmungen</h3>
            <p><strong>4.1 Datenschutz und Vertraulichkeit</strong></p>
            ...
            <p className="mt-4"><strong>4.2 Eigenwerbung</strong></p>
            ...
            <p className="mt-4"><strong>4.3 Haftungsbeschränkung</strong></p>
            ...
            <p className="mt-4"><strong>4.4 Rechtswahl und Gerichtsstand</strong></p>
            ...
            <p className="mt-8 text-sm text-gray-500">© 2025 Artyom Afoshin, Fotograf / Videograf, Frankfurt am Main</p>
          </div>
        </section>
      </main>
